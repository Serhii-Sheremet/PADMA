...
Generated on 09/26/2025 12:14:53
...
<Shell xmlns="http://schemas.microsoft.com/dotnet/2021/maui"
    ...
    <FlyoutItem Title="РљР°Р»РµРЅРґР°СЂСЊ" Route="MainPageRoute">
        <ShellContent ContentTemplate="{DataTemplate local:MainPage}" />
    </FlyoutItem>

    <!-- РЎС‚СЂР°РЅРёС†Р° РєРѕРЅС„РёРіСѓСЂР°С†РёРё -->
    <FlyoutItem Title="РќР°СЃС‚СЂРѕР№РєРё" Route="ConfigurationPageRoute">
...
<ContentPage xmlns="http://schemas.microsoft.com/dotnet/2021/maui"
             ...
             Title="РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ">

    <StackLayout Padding="20" Spacing="20">

        <Label Text="Р’С‹Р±РµСЂРёС‚Рµ РїРµСЂРІС‹Р№ РґРµРЅСЊ РЅРµРґРµР»Рё:" FontSize="16" />

        <RadioButton x:Name="MondayRadio" Content="РџРѕРЅРµРґРµР»СЊРЅРёРє" GroupName="FirstDayGroup" CheckedChanged="OnFirstDayCheckedChanged"/>
        <RadioButton x:Name="SundayRadio" Content="Р’РѕСЃРєСЂРµСЃРµРЅСЊРµ" GroupName="FirstDayGroup" CheckedChanged="OnFirstDayCheckedChanged"/>

        <!-- РљРЅРѕРїРєР° Р·Р°РєСЂС‹С‚РёСЏ СЃС‚СЂР°РЅРёС†С‹ -->
        <Button Text="Р—Р°РєСЂС‹С‚СЊ" VerticalOptions="End" HorizontalOptions="Center" Clicked="OnCloseClicked"/>
    </StackLayout>
</ContentPage>
